package smarthomesimulator.repository.room;
...
public class RoomRepository extends AbstractRepository<Room, String> {
    
    private static final String DATA_FILE = "rooms-data.json";
    ...
    @Override
    protected boolean matchesSearch(Room entity, String query) {
    ...
    @Override
    protected boolean matchesFilter(Room entity, String field, Object value) {
